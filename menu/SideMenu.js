      ...
      <View>
        ...
        <BackgroundScrollCalpulliX
          ...
          <View style={[styles.sectionHeadingStyle, { marginTop: 20 }]}>
            <Image
              style={{
                height: 25, width: 26, marginLeft: '5%',
            ...
            <Text style={{
              marginTop: 15, marginBottom: 15, fontSize: 16,
              marginLeft: '5%'
            }} onPress={this.navigateToScreen('ProductList')} >
              Lista de productos
              </Text>
          </View>
          ...
          <View style={[styles.sectionHeadingStyle]}>
            ...
            <Text style={{
              marginTop: 15, marginBottom: 15, fontSize: 16,
              marginLeft: '5%'
            }} onPress={this.navigateToScreen('PurchaseOrder')} >
              Ordenes de compra
              </Text>
          </View>
          <View style={[styles.sectionHeadingStyle]}>
            ...
            <Text style={{
              marginTop: 15, marginBottom: 15, fontSize: 16,
              marginLeft: '5%'
            }} onPress={this.navigateToScreen('ProfilePromotions')} >
              Promociones
              </Text>
          </View>
          <View style={[styles.sectionHeadingStyle]}>
          ...
          <View style={[styles.sectionHeadingStyle]}>
            ...
            <Text style={{
              marginTop: 15, marginBottom: 15, fontSize: 16,
              marginLeft: '5%'
            }} onPress={this.navigateToScreen('ClassifyUsers')} >
          ...
          <View style={[styles.sectionHeadingStyle]}>
            ...
            <Text style={{
              marginTop: 15, marginBottom: 15, fontSize: 16,
              marginLeft: '5%'
            }} onPress={this.navigateToScreen('Sales')} >
              Ventas
              </Text>
          </View>
          <View style={[styles.sectionHeadingStyle]}>
            ...
            <Text style={{
              marginTop: 15, marginBottom: 15, fontSize: 16,
              marginLeft: '5%'
            }} onPress={this.navigateToScreen('TwitterAnalysis')} >
              Analísis de Twitter
              </Text>
          </View>
          <View style={[styles.sectionHeadingBottomStyle]}>
            ...
            <Text style={{
              marginTop: 15, marginBottom: 15, fontSize: 16,
              marginLeft: '5%'
            }} onPress={this.navigateToScreen('Regression')} >
              Analisis predictivo
              </Text>
          </View>
          ...
          <View style={{ height: 50, backgroundColor: '#D17E11', flexDirection: 'row', marginTop: 80 }}>
            <Image
              style={{
                height: 25, width: 30, marginLeft: '5%',
            ...
            <Text style={{
              marginTop: 10, marginBottom: 10, fontSize: 16,
